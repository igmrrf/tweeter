...
module.exports = {
	...
	twitterConfig: {
		...
		retweet: Number(process.env.TWITTER_RETWEET_RATE) * 1000 * 60,
		like: Number(process.env.TWITTER_LIKE_RATE) * 1000 * 60,
		quote: Number(process.env.TWITTER_QUOTE_RATE) * 1000 * 60,
